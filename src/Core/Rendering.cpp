...
void WindowClass::processGui()
{
    ...
    Game::currentGuiLayer->p_absolute.w = (float)m_viewport.w; // Apparently, uhh this is modifying the x value instead of the width value
