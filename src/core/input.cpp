...
bool sre::key_pressed(sre::scanCode code) { return 1 == (engine.keyboard_state[code / 8] & (1 << (code % 8))); }

bool sre::button_pressed(sre::mouseButton button) { return 1 == (engine.mouse_press & SDL_BUTTON(button)); }
