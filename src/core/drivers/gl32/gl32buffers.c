...
{
    {
        ...
        SRE_GLCALLF(inst->glfuncs21.GetUniformLocation(d1program, "u_sampler"));
...

    {
        ...
        SRE_GLCALLF(inst->glfuncs21.BufferData(GL_UNIFORM_BUFFER, sizeof(struct sregl32_stateubo)*2, NULL, GL_DYNAMIC_DRAW));
